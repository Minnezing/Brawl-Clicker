...
function spawnBubble() {
    ...
    fx.addEventListener("click", (e) => popBubble(e, deleteInterval));
}
...
function popBubble(e, deleteTimeout) {
    ...
    gems += 60 * gemsPerSecond;
    createAddingFX(60 * gemsPerSecond, { x: e.clientX, y: e.clientY });

    setBrawlerData("hank", "earned", brawlers.find(brw => brw.id == "hank").earned + 60 * gemsPerSecond);
    setData("gems", gems);
}